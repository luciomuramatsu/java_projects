...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> allDegrees = new ArrayList<Integer>();
		for (int i = 0; i < getNumVertices(); i++) {
			allDegrees.add(getNeighbors(i).size() + getInNeighbors(i).size());
		}
	...
	public static void main (String[] args) {
		...
		GraphLoader.loadRoadMap("data/maps/baysideSF.map", graphFromFile);
